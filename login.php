...
<body>
    ...
    <div class="my-row-low">
        ...
        <nav class="navbar navbar-dark" style="background-color: #102EEF">
            <a class="navbar-brand" href="index.php"><img src="img/proimpo_logo.png" width='38' height='35'> Proimpo</a>
        </nav>
        </div>
        <div class="form-row justify-content-center my-row-high my-col">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="usuario_login" id="usuario_login">
        ...
        <div class="form-row justify-content-center my-col">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" name="passwd_login" id="passwd_login">
                    <div style="display:block;"></div>
                </div>
            </div>
        </div>
        <div class="row justify-content-center my-row-high">
            <div class="my-col">
                <input type="button" class="btn btn-primary" id="LoginUser" value="Log In">
            </div>
        </div>
        <div class="row justify-content-center my-row-high">
            <div class="my-col">
